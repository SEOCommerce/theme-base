        ...
        try {
            ...
            foreach(new \RecursiveIteratorIterator($baseViewIterator) as $file) {
                ...
                if (!file_exists($proxyViewPath)) {
                    ...
                    $filesystem->dumpFile($proxyViewPath, preg_match('/\.blade\.php/i', $relativePath) ? '@include(APP_THEME.\'::_base.'.$relativeBladePath.'\')' : '<?php echo $__env->make(APP_THEME.\'::_base.'.$relativeBladePath.'\', \Illuminate\Support\Arr::except(get_defined_vars(), [\'__data\', \'__path\']))->render(); ?>');
                }
            }
